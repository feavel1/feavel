<script>
	import { LucideUserX } from 'lucide-svelte';
</script>
...
<div class="text-center">
	...
	<h3 class="mt-2 text-sm font-semibold text-gray-900">No services are available</h3>
	<p class="mt-1 text-sm text-gray-500">Get started by creating a new service.</p>
	<div class="mt-6">
		<a
			href="/profile/services/create"
			type="button"
...
<div class="text-center">
	<LucideUserX class="mx-auto h-12 w-12 text-gray-400" />
