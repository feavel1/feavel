<main>
	<!-- Pricing section -->
	<div class="mx-auto pt-16 max-w-7xl px-6 sm:pt-32 lg:px-8">
		...
		<p class="mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-tertiary-700-200-token">
		...
		>
			<div class="rounded-3xl p-8 ring-1 ring-gray-200">
				<h2 id="tier-hobby" class="text-lg font-semibold leading-8">Hobby</h2>
				<p class="mt-4 text-sm leading-6 text-tertiary-700-200-token">
				...
				<p class="mt-6 flex items-baseline gap-x-1">
					...
					<span class="text-sm font-semibold leading-6 text-tertiary-700-200-token">/month</span>
				</p>
				<a
					href="#"
					...
					>Buy plan</a
				>
				<ul role="list" class="mt-8 space-y-3 text-sm leading-6 text-tertiary-700-200-token">
			...
			<div class="rounded-3xl p-8 ring-1 ring-gray-200">
				<h2 id="tier-freelancer" class="text-lg font-semibold leading-8">Freelancer</h2>
				<p class="mt-4 text-sm leading-6 text-tertiary-700-200-token">
					The essentials to provide your best work for clients.
				</p>
				<p class="mt-6 flex items-baseline gap-x-1">
			...
			<div class="rounded-3xl p-8 ring-2 ring-indigo-600">
				...
				<p class="mt-6 flex items-baseline gap-x-1">
					<!-- Price, update based on frequency toggle state -->
					<span class="text-4xl font-bold tracking-tight">$60</span>
					<!-- Payment frequency, update based on frequency toggle state -->
					<span class="text-sm font-semibold leading-6 text-tertiary-700-200-token">/month</span>
				</p>
				<a
			...
			<div class="rounded-3xl p-8 ring-1 ring-gray-200">
				<h2 id="tier-enterprise" class="text-lg font-semibold leading-8">Enterprise</h2>
				<p class="mt-4 text-sm leading-6 text-tertiary-700-200-token">
					Dedicated support and infrastructure for your company.
				</p>
				<p class="mt-6 flex items-baseline gap-x-1">
					<!-- Price, update based on frequency toggle state -->
					<span class="text-4xl font-bold tracking-tight">$90</span>
					<!-- Payment frequency, update based on frequency toggle state -->
					<span class="text-sm font-semibold leading-6 text-tertiary-700-200-token">/month</span>
				</p>
				<a
	...
	<div class="mx-auto mt-24 max-w-7xl px-6 sm:mt-32 lg:px-8">
		...
		<div class="mt-16 flex justify-center">
			<p
				class="relative rounded-full bg-gray-50 px-4 py-1.5 text-sm leading-6 text-tertiary-700-200-token ring-1 ring-inset ring-gray-900/5"
			>
				<span class="hidden md:inline"
					>Transistor saves up to $40,000 per year, per employee by working with us.</span
				>
				<a href="#" class="font-semibold text-indigo-600"
					><span class="absolute inset-0" aria-hidden="true"></span> See our case study
				...
				<div class="pt-6">
                  ...
                  -->
					...
					<dd class="mt-2 pr-12" id="faq-0">
						<p class="text-base leading-7 text-tertiary-700-200-token">
