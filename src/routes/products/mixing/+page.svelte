<div class="">
	<main>
		...
		<div class="isolate overflow-hidden">
			<div class="flow-root bg-gray-900-50-token py-16 sm:pt-48 lg:pb-0">
				<div class="mx-auto max-w-7xl px-6 lg:px-8">
					<div class="relative z-10">
						...
						<p class="mx-auto mt-4 max-w-2xl text-center text-lg leading-8 text-white/60">
							...
							odit doloribus molestiae voluptatum quos odit doloribus.
						</p>
					...
					<div
						class="relative mx-auto mt-10 grid max-w-md grid-cols-1 gap-y-8 lg:mx-0 lg:-mb-14 lg:max-w-none lg:grid-cols-3 text-surface-200"
					>
						<svg
						...
						<div
							class="relative rounded-2xl z-10 bg-surface-800-100-token text-surface-200-700-token shadow-xl ring-1 ring-gray-900/10"
						>
							<div class="p-8 lg:pt-12 xl:p-10 xl:pt-14">
								<h2 id="tier-scale" class="text-sm font-semibold leading-6">Scale</h2>
								<div
									class="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between lg:flex-col lg:items-stretch"
								>
									<div class="mt-2 flex items-center gap-x-4">
										<!-- Price, update based on frequency toggle state -->
										<p class="text-4xl font-bold tracking-tight">$60</p>
										<div class="text-sm leading-5">
											<p class="">USD</p>
											<!-- Payment frequency, update based on frequency toggle state -->
			...
			<div class="relative bg-surface-800-100-token text-surface-50-900-token lg:pt-14">
				<div class="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
						...
						<div class="mx-auto max-w-2xl space-y-16">
							<div class="border-t border-gray-900/10">
								<div class="-mt-px w-72 border-t-2 pt-10 md:w-80 border-transparent">
									<h3 class="text-sm font-semibold leading-6">Starter</h3>
								...
								<div class="mt-10 space-y-10">
									<div>
										...
										<div class="relative mt-6">
											...
											<div
												aria-hidden="true"
												class="pointer-events-none absolute inset-y-0 right-0 hidden w-1/2 rounded-lg sm:block ring-1 ring-gray-900/10"
											></div>
										</div>
									</div>
									<div>
										<h4 class="text-sm font-semibold leading-6">Other perks</h4>
										<div class="relative mt-6">
											<!-- Fake card background -->
											<div
												aria-hidden="true"
								...
								<div class="mt-10 space-y-10">
									<div>
										...
										<div class="relative mt-6">
											...
											<div
												aria-hidden="true"
												class="pointer-events-none absolute inset-y-0 right-0 hidden w-1/2 rounded-lg sm:block ring-2 ring-indigo-600"
											></div>
										</div>
									</div>
									<div>
							...
							<div class="border-t border-gray-900/10">
								<div class="-mt-px w-72 border-t-2 pt-10 md:w-80 border-transparent">
									<h3 class="text-sm font-semibold leading-6">Growth</h3>
									<p class="mt-1 text-sm leading-6 text-gray-600">
					...
					<section aria-labelledby="comparison-heading" class="hidden lg:block">
						...
						<div class="grid grid-cols-4 gap-x-8 border-t border-gray-900/10 before:block">
							<div aria-hidden="true" class="-mt-px">
								<div class="border-t-2 pt-10 border-transparent">
									<p class="text-sm font-semibold leading-6">Starter</p>
									<p class="mt-1 text-sm leading-6 text-gray-600">
										All your essential business finances, taken care of.
									</p>
								</div>
							...
							<div aria-hidden="true" class="-mt-px">
								<div class="border-t-2 pt-10 border-transparent">
									<p class="text-sm font-semibold leading-6">Growth</p>
									<p class="mt-1 text-sm leading-6 text-gray-600">
										Convenient features to take your business to the next level.
									</p>
								</div>
						...
						<div class="-mt-6 space-y-16">
							<div>
								<h3 class="text-sm font-semibold leading-6">Catered for business</h3>
									...
									<table class="relative w-full border-separate border-spacing-x-8">
										...
										<tbody>
											<tr>
												<th
													scope="row"
													class="w-1/4 py-3 pr-4 text-left text-sm font-normal leading-6"
												>
													Tax Savings
											...
											<tr>
												...
												<td class="relative w-1/4 px-4 py-0 text-center">
													<span class="relative h-full w-full py-3">
														<span class="text-sm leading-6">3 accounts</span>
													</span>
												</td>
												<td class="relative w-1/4 px-4 py-0 text-center">
													<span class="relative h-full w-full py-3">
														<span class="text-sm leading-6 font-semibold text-indigo-600"
												...
												<td class="relative w-1/4 px-4 py-0 text-center">
													<span class="relative h-full w-full py-3">
														<span class="text-sm leading-6">7 accounts</span>
													</span>
												</td>
											</tr>
											<tr>
												...
												<td class="relative w-1/4 px-4 py-0 text-center">
													<span class="relative h-full w-full py-3">
														<span class="text-sm leading-6">3 invoices</span>
													</span>
												</td>
												<td class="relative w-1/4 px-4 py-0 text-center">
													<span class="relative h-full w-full py-3">
												...
												<td class="relative w-1/4 px-4 py-0 text-center">
													<span class="relative h-full w-full py-3">
														<span class="text-sm leading-6">10 invoices</span>
													</span>
												</td>
											</tr>
											<tr>
							...
							<div>
								<h3 class="text-sm font-semibold leading-6">Other perks</h3>
								<div class="relative -mx-8 mt-10">
									<!-- Fake card backgrounds -->
									<div
										class="absolute inset-x-8 inset-y-0 grid grid-cols-4 gap-x-8 before:block"
