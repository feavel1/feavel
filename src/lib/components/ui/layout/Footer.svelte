...
<footer class="mt-32 sm:mt-40" aria-labelledby="footer-heading">
	...
	<div class="mx-auto max-w-7xl px-6 pb-8 lg:px-8">
		<div class="border-t border-primary-900/10 pt-20 xl:grid xl:grid-cols-3 xl:gap-8">
			...
			<div class="mt-10 xl:mt-0">
				...
				<form class="mt-6 sm:flex sm:max-w-md">
					...
					<input
						...
						autocomplete="email"
						required
						class="w-full min-w-0 appearance-none rounded-md border-0 bg-white px-3 py-1.5 text-base text-primary-900 shadow-sm ring-1 ring-inset ring-primary-300 placeholder:text-primary-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:w-64 sm:text-sm sm:leading-6 xl:w-full"
		...
		<div
			class="mt-16 border-t border-primary-900/10 pt-8 sm:mt-20 md:flex md:items-center md:justify-between lg:mt-24"
		>
