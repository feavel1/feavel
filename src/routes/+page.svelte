...
<main>
	...
	<div class="relative isolate overflow-hidden">
		<svg
			class="absolute inset-0 -z-10 h-full w-full stroke-tertiary-400 [mask-image:radial-gradient(100%_100%_at_top_right,white,transparent)]"
			aria-hidden="true"
		>
			<defs>
				<pattern
			...
			<svg x="50%" y="-1" class="overflow-visible fill-surface-500/20">
				<path
	...
	<div class="overflow-hidden py-24 sm:py-32">
		<div class="mx-auto max-w-7xl px-6 lg:px-8">
			...
			>
				<div class="lg:pr-8 lg:pt-4 flex flex-col">
					<div class="lg:max-w-lg">
						<h2 class="text-base font-semibold leading-7 text-primary-600-300-token">
							Create faster
						</h2>
						<p class="mt-2 text-3xl font-bold tracking-tight sm:text-4xl">
							Audio mixing and engeniering
						</p>
						<p class="mt-6 text-lg leading-8 text-tertiary-600">
						...
						<dl
							class="mt-10 max-w-xl space-y-8 text-base leading-7 text-tertiary-600 lg:max-w-none"
						>
							<div class="relative pl-9">
								<dt class="inline font-semibold text-surface-900-50-token">
									<svg
					...
					<div class="mt-10 flex items-center justify-center gap-x-6 lg:justify-start">
						<a
							...
							class="rounded-md bg-surface-600 px-3.5 py-2.5 text-sm font-semibold text-surface-50 shadow-sm hover:bg-surface-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
						>
							Get started
						</a>
						<a href="/products/mixing" class="text-sm font-semibold leading-6 text-white">
							Learn more
							<span aria-hidden="true">→</span>
						</a>
					</div>
	...
	<div class=" py-24 sm:py-32">
		<div class="mx-auto max-w-7xl px-6 lg:px-8">
			<div class="mx-auto max-w-2xl lg:text-center">
				...
				<p class="mt-2 text-3xl font-bold tracking-tight text-surface-900-50-token sm:text-4xl">
					Producing and Beat making
				</p>
				<p class="mt-6 text-lg leading-8 text-tertiary-600">
			...
			<div class="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl">
				...
				>
					<div class="relative pl-16">
						<dt class="text-base font-semibold leading-7 text-surface-900-50-token">
							<div
						...
						<dd class="mt-2 text-base leading-7 text-tertiary-600">
	...
	<div class=" py-24 sm:py-32">
		<div class="mx-auto max-w-7xl px-6 lg:px-8">
			<div class="mx-auto max-w-2xl sm:text-center">
				...
				<p class="mt-2 text-3xl font-bold tracking-tight text-surface-900-50-token sm:text-4xl">
					Game, Film and Advertisement Scoring
				</p>
				<p class="mt-6 text-lg leading-8 text-tertiary-600">
					Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit perferendis
