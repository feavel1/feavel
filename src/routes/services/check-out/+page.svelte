<script lang="ts">
	import EpayCore from '$lib/epay/EpayCore.js';
	...
	let trade_number = 'ord_' + generateUUID();
	let epayCore: EpayCore;

	onMount(() => {
		// Initialize EpayCore with your configuration
		epayCore = new EpayCore({
			pid: 'https://api.jcckj.asia/',
			key: '1025',
			apiurl: 'Je7oF8n28uu0g8bRXuf02juR8g8uN6ui'
		});
	});
	...
	async function initiatePayment() {
		try {
			const paymentParams = {
				...
				money: transformedService.price // 1 RMB
			};

			const paymentForm = epayCore.pagePay(paymentParams);
		...
		<div class="mx-auto w-full max-w-lg">
			...
			<div class="relative mt-8">
				...
				<div class="relative flex justify-center">
					<span class="bg-white rounded-lg px-4 text-sm font-medium text-gray-500">or</span>
				</div>
			</div>
